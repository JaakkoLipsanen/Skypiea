...
namespace Zombie.Screens
{
    public class GameOverScreen : GameScreen
    {
        ...
        private void CreateUiElements()
        {
            ...
            TextButton replayButton = new TextButton("Play again!", new Vector2(screenSize.Width / 4f, screenSize.Height / 2f));
            replayButton.Click += () =>
            {
                this.ExitScreen();
                _gameContainer.Restart();
            };
            _uiContainer.Add(replayButton);

            TextButton exitButton = new TextButton("Exit", new Vector2(screenSize.Width / 4f * 3f, screenSize.Height / 2f));
            exitButton.Click += () => this.ScreenManager.Game.Exit();
